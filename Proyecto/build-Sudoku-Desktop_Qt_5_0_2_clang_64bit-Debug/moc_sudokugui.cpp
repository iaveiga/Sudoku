...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SudokuGUI_t, stringdata) + ofs \
...
const QMetaObject SudokuGUI::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SudokuGUI.data,
      qt_meta_data_SudokuGUI,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SudokuGUI.stringdata))
